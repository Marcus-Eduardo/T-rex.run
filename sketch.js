var trex, trex_correndo, bordas, solo, soloInvisivel, imagemDaNuvem, obstaculo, pontuacao, grupoDeNuvens, grupoDeObstaculos, trex_colidiu,somPulo,somMorte,somPoint,fonte;
...
function gerarObstaculos(){
  ...
  if(frameCount %60 === 0){
    obstaculo = createSprite(600,180,10,40);
